...
process.stdin.on('data', async chunk => {
  ...
  if (/global\//.exec(inputName)) {
    let _inputName = inputName.replace('global/', '')
    _inputName = upperFirst(camelCase(_inputName))
    inputName = `global/${_inputName}`
  } else {
    inputName = upperFirst(camelCase(inputName))
  }
  ...
  if (hasComponentDirectory) {
    ...
    // componentDirectory = upperFirst(componentDirectory)
